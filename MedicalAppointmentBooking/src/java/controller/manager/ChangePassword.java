...
public class ChangePassword extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("frontend/view/changepass.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String curPass = (String) session.getAttribute("password");
        response.getWriter().print(curPass);
        response.getWriter().print(oldpassword);
        if (oldpassword.equals("") || newpassword.equals("") || confirmpassword.equals("")) {
            request.setAttribute("error", "Please enter 2 identical passwords!");

            request.getRequestDispatcher("frontend/view/changepass.jsp").forward(request, response);
        } else if (!curPass.equals(oldpassword.trim())) {
