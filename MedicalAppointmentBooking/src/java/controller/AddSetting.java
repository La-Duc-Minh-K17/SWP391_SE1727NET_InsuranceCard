...
public class AddSetting extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Boolean settingStatus = request.getParameter("settingStatus").equals("Active");
        
        Setting st = new Setting();
        st.setType(settingType);
        st.setValue(settingValue);
        st.setDescription(settingDescription);
        st.setStatus(settingStatus);
        
        SettingDBContext db = new SettingDBContext();
        db.insertSetting(st);
         //request.setAttribute("settings",st);
         request.getRequestDispatcher("frontend/view/settingList.jsp").forward(request, response);
    }
