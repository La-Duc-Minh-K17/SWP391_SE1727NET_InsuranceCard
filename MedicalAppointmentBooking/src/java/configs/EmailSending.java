...
public class EmailSending {
    ...
    public static void sendRecoverAccount(String username, String urlLink, String emailTo) {
    ...
    public static void sendVerificationMail(String username, String urlLink, String emailTo) {
        String subject = "[MABS] Please verify your email.";
        String message = "<!DOCTYPE html>\n"
                + "<html lang=\"en\">\n "
                + "\n"
                + "<head>\n "
                ...
                + "    <div>Here's the verification link for your account : <a href=\"" + urlLink + "\">Click here!</a></div>\n"
                + "    <div>This mail is automatically generated.</div>\n"
                + "    <div>If you need help or have questions, please response to  ... anytime.</div>\n"
