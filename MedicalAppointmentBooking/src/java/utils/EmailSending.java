...
public class EmailSending {
    ...
    public static void sendReminderEmail(Reservation resv) {
        ...
        String message = "<!doctype html>\n"
                ...
                + "                                                        style=\"padding: 10px; border-right: 1px solid #ededed; width: 35%;font-weight:500; \">\n"
                + "                                                        Reason:</td>\n"
                + resv.getResvNote() + "<td style=\"padding: 10px; \"></td>\n"
                + "                                                </tr>\n"
                + "                                            </tbody>\n"
                + "                                        </table>\n"
                + "                                    </td>\n"
    ...
    public static void sendVerificationMailAdmin1(UserAccount user, String url, String emailTo) {
        String subject = "[MABS] ACCOUNT CONFIRMATION";
        String message = "<!DOCTYPE html>\n"
                + "<html lang=\"en\">\n"
                + "\n"
                ...
                + "                                        <span style=\"display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;\"></span>\n"
                + "                                        <p style=\"color:#455056; font-size:15px; line-height:24px; margin:0;\">\n"
                + "                                            Your account is almost ready with password: " + user.getPassword() + ". Please confirm your account and change password after confirm.\n"
                + "                                        </p>\n"
                + "                                        <a href=\" " + url + "\" style=\"background:#e27720; text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff; text-transform:uppercase; font-size:14px; padding:10px 24px; display:inline-block; border-radius:50px;\">\n"
                + "                                            Confirm Account\n"
                + "                                        </a>\n"
    ...
    public static void sendRejectEmail(Appointment appt) {
        String subject = "[MABS] REMINDER EMAIL";
        String message = "<!doctype html>\n"
                + "<html lang=\"en-US\">\n"
                + "\n"
                ...
                + "                                                <td>\n"
                + "                                                    <div>\n"
                + "                                                        <p>Dear " + appt.getPatient().getFullName() + "</p>\n"
                + "                                                        <p>\n"
                + "                                                            Thank you for your email and for requesting an appointment\n"
                + "                                                            with\n"
                + "                                                            our clinic. I appreciate your interest in meeting with us.\n"
                + "                                                        </p>\n"
                + "                                                        <p>\n"
                + "                                                            Unfortunately, we are unable to accept your request for\n"
                + "                                                            below appointment at this\n"
                + "                                                            time:\n"
                + "                                                        <table cellpadding=\"0\" cellspacing=\"0\"\n"
                + "                                                            style=\"width: 100%; border: 1px solid #ededed\">\n"
                + "                                                            <tbody>\n"
    ...
    public static void sendRejectEmail(Reservation resv) {
        String subject = "[MABS] REMINDER EMAIL";
        String message = "<!doctype html>\n"
                + "<html lang=\"en-US\">\n"
                + "\n"
                ...
                + "                                                <td>\n"
                + "                                                    <div>\n"
                + "                                                        <p>Dear" + resv.getPatient().getFullName() + "</p>\n"
                + "                                                        <p>\n"
                + "                                                            Thank you for your email and for requesting an appointment\n"
                + "                                                            with\n"
                + "                                                            our clinic. I appreciate your interest in meeting with us.\n"
    ...
    public static void sendCancellationNotice(Appointment appt) {
        String subject = "[MABS] REMINDER EMAIL";
        String message = "<!doctype html>\n"
                + "<html lang=\"en-US\">\n"
                + "\n"
                ...
                + "                                                <td>\n"
                + "                                                    <div>\n"
                + "                                                        <p>Patient " + appt.getPatient().getFullName() + " has cancelled the appointment</p>\n"
                + "                                                      \n"
                + "                                                        <p>\n"
                + "                                                           \n"
                + "                                                        <table cellpadding=\"0\" cellspacing=\"0\"\n"
        ...
        String emailTo = appt.getPatient().getEmail();
        EmailSending.sendEmail(emailTo, subject, message);
        EmailSending.sendEmail(appt.getDoctor().getEmail(), subject, message);
    }

    public static void sendCancellationNotice(Reservation resv) {
        String subject = "[MABS] REMINDER EMAIL";
        String message = "<!doctype html>\n"
                + "<html lang=\"en-US\">\n"
                + "\n"
                ...
                + "                                                <td>\n"
                + "                                                    <div>\n"
                + "                                                        <p>Patient" + resv.getPatient().getFullName() + "has cancelled the appointment</p>\n"
                + "                                                      \n"
                + "                                                        <p>\n"
                + "                                                           \n"
                + "                                                        <table cellpadding=\"0\" cellspacing=\"0\"\n"
