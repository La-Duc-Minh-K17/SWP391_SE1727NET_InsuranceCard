...
function validatePassword(input) {
    ...
    let regex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*(\W|_)).{8,}$/;
    // Add your validation logic here
    if (!regex.test(password)) {
        input.setCustomValidity("Password should be more than 8 characters, contain at least one lowercase, one uppercase, one digit and one special character.");
    } else {
...
function validatePhone(input) {
    ...
    // Add your validation logic here
    if (!regex.test(phone)) {
        input.setCustomValidity("Phone should contain just 10 digits.");
    } else {
        input.setCustomValidity(""); // Clear any custom validation message
    }
}
function validateEmail(input) {
    ...
    // Add your validation logic here
    if (!regex.test(email)) {
        input.setCustomValidity("Email should be in correct form.");
    } else {
        input.setCustomValidity(""); // Clear any custom validation message
    }
}