...
<html>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-home d-flex bg-light align-items-center" style="background: url('frontend/template/assets/images/bg/bg-lines-one.png') center;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-8">
                        <img src="frontend/template/assets/images/logo-dark.png" height="24" class="mx-auto d-block" alt="">
