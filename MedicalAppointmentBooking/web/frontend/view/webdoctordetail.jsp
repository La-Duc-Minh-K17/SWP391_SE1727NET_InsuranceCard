                        ...
                        <div class="text-center">
                            <div class="mt-5 pt-2">
                                <div class="d-flex justify-content-center">
                                    <a href="WebDoctorDetail?action=book-doctor&doctorId=${doctor.doctorId}" class="btn btn-outline-primary btn-lg">Book Now</a>
                                </div>
                            </div>
                        </div><!--end text-center-->
                    </div>    
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-smart" role="tabpanel"
                                    ...
                                    <div class="p-5">
                                        ...
                                        <form action="WebDoctorDetail?action=comment&doctorId=${doctor.doctorId}" method="post" class="mt-3">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
