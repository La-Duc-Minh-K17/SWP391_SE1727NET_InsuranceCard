                    ...
                    <div class="mt-100" id="edit" role="tabpanel" aria-labelledby="edit">
                        <div class="card border-0 shadow overflow-hidden">
                            <div class="tab-content p-4" id="pills-tabContent">
                                <form action="<c:url value='/manageblog?action=edit-info&doctor_id=${blog.blog_id}'/>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="fullname" id="name" type="text" class="form-control" value="${blog.title}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Description</label>
                                            <input name="position"  type="text"  class="form-control" value="${blog.description}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Content</label>
                                            <input name="position"  type="text"  class="form-control" value="${blog.content}">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Edit Time</label>
                                            <input name="description" type="date" class="form-control" value="${blog.created_time}">
                                        </div>
                                    </div>
                                </div>
