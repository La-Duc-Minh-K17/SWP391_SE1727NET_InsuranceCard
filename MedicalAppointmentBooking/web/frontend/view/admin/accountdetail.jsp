                                ...
                                <form style="padding: 20px;" action="AccountDetail" method="post" id="searchform" class="searchform">
                                    <div class="row align-content-center justify-content-center">
                                        ...
                                        <div class="col-xl-6 col-md-6 p-1">
                                            ...
                                            <input class="form-control" type="text" readonlyname="fullname" value="${acc.fullName}" id="fullname" >
                                        </div>
                                        <div class="col-xl-6 col-md-6 p-1">
                                            <label>Role:</label>
                                        ...
                                        <div class="col-xl-6 col-md-6 p-1">
                                            <label>Phone:</label>
                                            <input class="form-control" type="text" readonly name="phone" value="${acc.phone}" id="phone" >
                                        </div>
                                        <div class="col-xl-6 col-md-6 p-1">
                                            <label>Dob: </label>
                                            <input class="form-control" type="date" readonly name="dob" value="${acc.dob}" id="dob" >
                                        </div>
                                        <div class="col-xl-6 col-md-6 p-1">
                                            <label>Gender:</label>
                                            <p></p>
                                            <input type="radio" name="gender"disabled  ${acc.status == 1 ?"checked":""} value="1" id="gender" checked="" > Male
                                            <input type="radio" name="gender"disabled  ${acc.status == 0 ?"checked":""} value="0" id="gender"  > Female
                                        </div>
                                        <div class="col-xl-6 col-md-6 p-1">
                                            <label>Status:</label>
                                            <p></p>
                                            <input type="radio" name="status"disabled ${acc.status == 1 ?"checked":""} value="1" id="gender"  > Active
                                            <input type="radio" name="status" disabled=""  ${acc.status == 0 ?"checked":""} value="0" id="gender"  > Inactive
                                        </div>
