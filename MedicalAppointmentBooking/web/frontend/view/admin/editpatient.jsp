<%-- 
    ...
    Created on : Oct 19, 2023, 1:39:43 PM
    Author     : PC
--%>
                    ...
                    <div class="mt-100" id="edit" role="tabpanel" aria-labelledby="edit">
                        <div class="card border-0 shadow overflow-hidden">
                            <div class="tab-content p-4" id="pills-tabContent">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td><input id="" name="gender" ${p.gender== 1?"checked":""} value="1" type="radio" class="form-check-input"
                                                                   checked required ></td>
                                                        <td><label class="form-check-label">Male</label></td>
                                                        <td></td>
                                                        <td><input id="" name="gender" ${p.gender==0 ?"checked":""} value="0" type="radio" class="form-check-input"
                                                                   required></td>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td><input id="" name="status" ${p.status== 1?"checked":""} value="1" type="radio" class="form-check-input m-3 "
                                                                   checked required ></td>
                                                        <td><label class="form-check-label mt-3 mb-3">Activate</label></td>
                                                        <td></td>
                                                        <td><input id="" name="status" ${p.status==0 ?"checked":""} value="0" type="radio" class="form-check-input m-3"
                                                                   required></td>
                                ...
                                <div class="row">
                                    <div class=" col-lg-9">
                                        <a href="<c:url value='/manage-patient?action=view-all'/> " class="btn btn-primary mt-5 ">Return</a>
                                    </div>
                                    <div class="col-lg-3">
